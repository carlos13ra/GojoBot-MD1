...
export default {
  ...
  run: async (client, m) => {
    exec('git pull', async (error, stdout, stderr) => {
      ...
      await client.sendContextInfoIndex(m.chat, msg, {}, m, true, null, {
        banner: global.db.data.settings[client.user.id.split(':')[0] + '@s.whatsapp.net'].icon,
        title: '₍ᐢ..ᐢ₎  ˚₊ Complete update .  ◌Ⳋ𝅄',
        body: global.db.data.settings[client.user.id.split(':')[0] + '@s.whatsapp.net'].namebot
      })
