...
async function getVideoFromApis(url) {
  const apis = [
    { api: 'Nexuz Light', endpoint: `${api.url}/download/ytdl?url=${encodeURIComponent(url)}&type=video&quality=360`, extractor: res => res?.result?.dl_url },
